...
<link rel="stylesheet" href="{{ asset('dashboard/vendor/libs/apex-charts/apex-charts.css') }} " />
    ...
    <link rel="stylesheet"
        href="{{ asset('dashboard/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }} " />
...
<!-- Page JS -->
<script src="{{ asset('dashboard/js/app-ecommerce-dashboard.js') }} "></script>
@endsection
@section('content')
          ...
          <div class="d-flex align-items-end row">
            ...
            <div class="col-5 text-center text-sm-left">
              <div class="card-body pb-0 px-0 px-md-4">
                <img
                  src="http://127.0.0.1:8000/dashboard/img/illustrations/card-advance-sale.png"
                  height="140"
                  alt="view sales" />
              </div>
            </div>
          ...
          <div class="card-body">
            <ul class="p-0 m-0">
              <li class="d-flex mb-4 pb-1">
                <div class="me-3">
                  <img src="http://127.0.0.1:8000/dashboard/img/products/iphone.png" alt="User" class="rounded" width="46" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="me-3">
                  <img
                    src="http://127.0.0.1:8000/dashboard/img/products/nike-air-jordan.png"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="me-3">
                  <img src="http://127.0.0.1:8000/dashboard/img/products/headphones.png" alt="User" class="rounded" width="46" />
                </div>
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  <div class="me-2">
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="me-3">
                  <img
                    src="http://127.0.0.1:8000/dashboard/img/products/apple-watch.png"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
              ...
              <li class="d-flex mb-4 pb-1">
                <div class="me-3">
                  <img
                    src="http://127.0.0.1:8000/dashboard/img/products/amazon-echo.png"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
              ...
              <li class="d-flex">
                <div class="me-3">
                  <img
                    src="http://127.0.0.1:8000/dashboard/img/products/play-station.png"
                    alt="User"
                    class="rounded"
                    width="46" />
                </div>
