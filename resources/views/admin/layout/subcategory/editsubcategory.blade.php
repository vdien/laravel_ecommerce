                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select id="category_id" name="category_id" class="form-select">
                                    <option value="{{   $subcategory_info->category_id}}" selected>{{  $subcategory_info->category_name}}</option>
                                    @foreach ($categories as $category)
                                    @if ("{{$subcategory_info->category_name  }}" !== "{{ $category->category_name }}");
