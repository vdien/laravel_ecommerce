    ...
    var dt_products = dt_product_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $name = full['product_name'],
              $id = full['id'],
              $product_brand = full['product_subcategory_name'],
            ...
            if ($image) {
              ...
              var $state = states[stateNum],
                $name = full['product_subcategory_name'],
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $category = full['product_category_name'];
            return (
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var $product_brand = full['product_subcategory_name'];
            var select = $(
            ...
            column
              ...
              .sort()
              .each(function (d, j) {
                select.append('<option value="' + $product_brand + '">' + $product_brand + '</option>');
              });
          });
